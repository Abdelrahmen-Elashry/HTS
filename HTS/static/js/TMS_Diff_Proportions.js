// Main form submission function for two-proportion test
async function submitTwoProportionForm(event) {
    ...
    try {
        ...
        // API Request
        const response = await fetch('/calculate_two_proportions', {
            method: 'POST',
...
// Input validation for success counts
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('hypothesisForm');
    form.addEventListener('submit', submitTwoProportionForm);

    // Add validation for success counts

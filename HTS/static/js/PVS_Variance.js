// Main form submission function for variance p-value method
async function submitVariancePValueForm(event) {
    ...
    try {
        ...
        // API Request to variance p-value endpoint
        const response = await fetch('/calculate_variance_pvalue', {
            method: 'POST',
        ...
        // Display results - modified for variance p-value output
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('hypothesisForm');
    form.addEventListener('submit', submitVariancePValueForm);
    ...
    // Validation for alpha (significance level)
